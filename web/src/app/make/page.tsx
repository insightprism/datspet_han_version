...
/**
 * Make your own pet — the free-text / reference-image describe flow. Reached from
 * the Design landing's "Describe a pet instead" (the landing is the app home now;
 * this is the page you navigate TO for the blank-slate path). "Design your own"
 * links back to home (/).
 */
